            ...
            {announcementActive ? (
              <div className="bg-gradient-to-r from-[#6b1d2f] via-[#8b2d3f] to-[#521321] text-white text-xs py-2.5 px-4 rounded-xl shadow-md border border-amber-500/20 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex-1 text-center font-bold text-white flex items-center justify-center gap-2 min-w-[200px]">
                  ...
                  <span>{announcement || "(Duyuru metni girilmedi)"}</span>
                  {announcement2 && <span className="text-amber-200/80 font-normal">• {announcement2}</span>}
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#6b1d2f]/20 bg-white text-slate-900"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3.5 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#6b1d2f]/20 bg-white text-slate-900"
                  />
                </div>
              </div>
