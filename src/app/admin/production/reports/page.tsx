...
export const metadata = {
  title: "Üretim Raporları | Atak Arıcılık Yönetim Paneli",
  description: "İmalat istatistikleri, fire oranları, makine dolulukları ve PDF raporlama çıktıları.",
};
      ...
      <Suspense
        fallback={
          <div className="flex flex-col items-center justify-center py-24 space-y-4">
            ...
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Raporlar Derleniyor...</p>
          </div>
        }
      >
        <ReportsClient initialData={result.data} />
      </Suspense>
    </div>
  );
}
