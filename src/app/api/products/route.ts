    ...
    const product = await prisma.product.create({
      data: {
        ...
        attributes: {
          ...(data.attributes || {}),
          ...(body.attributes || {}),
          shortDesc: data.shortDesc || body.shortDesc,
          barcode: data.barcode || body.barcode,
          unit: data.unit || body.unit,
          manufacturerCode: data.manufacturerCode || body.manufacturerCode,
          brand: data.brand || body.brand,
          model: data.model || body.model,
          stockType: data.stockType || body.stockType,
          warehouse: data.warehouse || body.warehouse,
          recipeDetails: data.recipeDetails || body.recipeDetails,
          altitude: data.altitude || body.altitude,
          harvestSeason: data.harvestSeason || body.harvestSeason,
          harvestStory: data.harvestStory || body.harvestStory,
          ingredients: data.ingredients || body.ingredients,
          ritual: data.ritual || body.ritual,
          nutrients: data.nutrients || body.nutrients || (data.attributes?.nutrients) || (body.attributes?.nutrients),
          hmfLevel: data.hmfLevel || body.hmfLevel,
          specsMaterial: data.specsMaterial || body.specsMaterial,
          specsWeight: data.specsWeight || body.specsWeight,
          specsDimensions: data.specsDimensions || body.specsDimensions,
          specsBellows: data.specsBellows || body.specsBellows,
          usageGuide: data.usageGuide || body.usageGuide,
          warrantyInfo: data.warrantyInfo || body.warrantyInfo,
          warrantyBadgeLabel: data.warrantyBadgeLabel || body.warrantyBadgeLabel,
          warrantyYears: data.warrantyYears || body.warrantyYears,
          warrantyBadgeDesc: data.warrantyBadgeDesc || body.warrantyBadgeDesc,
          quickOverview1_title: data.quickOverview1_title || body.quickOverview1_title,
          quickOverview1_desc: data.quickOverview1_desc || body.quickOverview1_desc,
          quickOverview2_title: data.quickOverview2_title || body.quickOverview2_title,
          quickOverview2_desc: data.quickOverview2_desc || body.quickOverview2_desc,
          quickOverview3_title: data.quickOverview3_title || body.quickOverview3_title,
          quickOverview3_desc: data.quickOverview3_desc || body.quickOverview3_desc,
          longDescExtra: data.longDescExtra || body.longDescExtra,
          badgeText1: data.badgeText1 || body.badgeText1,
          badgeText2: data.badgeText2 || body.badgeText2,
          unitCoefficients: data.unitCoefficients || body.unitCoefficients,
          branchPrices: data.branchPrices || body.branchPrices,
          marketplaces: data.marketplaces || body.marketplaces,
          b2bActive: data.b2bActive ?? body.b2bActive ?? true,
          b2bPreOrderable: data.b2bPreOrderable ?? body.b2bPreOrderable ?? false,
          purchaseCurrency: data.purchaseCurrency || body.purchaseCurrency || "TRY",
          purchaseVat: data.purchaseVat || body.purchaseVat || "20",
          purchaseVatIncluded: data.purchaseVatIncluded ?? body.purchaseVatIncluded ?? false,
          saleCurrency: data.saleCurrency || body.saleCurrency || "TRY",
          saleVat: data.saleVat || body.saleVat || "20",
          saleVatIncluded: data.saleVatIncluded ?? body.saleVatIncluded ?? true,
          retailPrice: data.retailPrice ?? body.retailPrice ?? 0,
          retailCurrency: data.retailCurrency || body.retailCurrency || "TRY",
          retailVat: data.retailVat || body.retailVat || "20",
          retailVatIncluded: data.retailVatIncluded ?? body.retailVatIncluded ?? true,
          webPrice: data.webPrice ?? body.webPrice ?? 0,
          webCurrency: data.webCurrency || body.webCurrency || "TRY",
          webVat: data.webVat || body.webVat || "20",
          webVatIncluded: data.webVatIncluded ?? body.webVatIncluded ?? true,
          marketPrice: data.marketPrice ?? body.marketPrice ?? 0,
          marketCurrency: data.marketCurrency || body.marketCurrency || "TRY",
          marketVat: data.marketVat || body.marketVat || "20",
          marketVatIncluded: data.marketVatIncluded ?? body.marketVatIncluded ?? true,
        },
